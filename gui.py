...
from bot import greeting_response
...
class chatBotApplication:
    ...
    def _setup_main_window(self):
        self.window.title("Chat with Doc Bot")
    ...
    # head label
        ...
        # send button
        send_button = Button(bottom_label, text="Send", font="Helvetica 13 bold", width=20, bg="#ABB2B9",
    ...
    def _insert_message(self, msg, sender):
        ...
        msg2 = f"{'Doc Bot'}: {greeting_response(msg)}\n\n"
        self.text_widget.configure(state=NORMAL)
